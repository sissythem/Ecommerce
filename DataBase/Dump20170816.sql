...
INSERT INTO `conversations` VALUES (7,1,2,1,'hi',1,0,0,0),(9,1,6,9,'Your Perfect Residence',1,0,0,0);
...
CREATE TABLE `reservations` (
  ...
  `start_date` bigint(50) DEFAULT NULL,
  `end_date` bigint(50) DEFAULT NULL,
...
CREATE TABLE `residences` (
  ...
  `guests` int(11) DEFAULT NULL,
  `available_date_start` bigint(50) DEFAULT NULL,
  `available_date_end` bigint(50) DEFAULT NULL,
...
INSERT INTO `residences` VALUES (1,2,'Great Appartment in Greece!','no','about','no','Greece','fjjgrp','athens','no','no',1,2,2,1,1,'yes',20.5,'img8098974172243672423.jpg',1,NULL,NULL,200,50,1),(3,6,'Perfect place for honeymoon!','no','about','no','Netherlands','grifgjr','Amsterdam','no','no',3,1,1,1,1,'no',45.5,'no',1,NULL,NULL,300,30,1),(4,6,'House next to the beach','no','about','no','Netherlands','grifgjr','amsterdam','no','no',3,1,1,1,1,'no',45.5,'img4142690840594364987.jpg',2,NULL,NULL,300,30,1),(5,6,'Mary\'s perfect place','no','about','no','Netherlands','grifgjr','Amsterdam','no','no',3,1,1,1,1,'no',45.5,'no',1,NULL,NULL,300,30,1),(6,6,'Unforgattable moments in this room','no','about','no','Netherlands','grifgjr','Amsterdam','no','no',3,1,1,1,1,'no',45.5,'no',1,NULL,NULL,300,30,1),(8,6,'Test Title Residence','no','about','no','Netherlands','grifgjr','Amsterdam','no','no',3,1,1,1,1,'no',45.5,'no',1,NULL,NULL,300,30,1),(9,6,'Your Perfect Residence','Apartment','about','no','France','3 Rue de la Cité 75004 ','Paris','no','no',3,1,1,1,1,'no',45.5,'no',1,NULL,NULL,300,30,1),(18,2,'Sea, Wine and love','Apartrment','rhj','gj','d h','ryj','fj','hk','gj',7,8,6,0,0,'t to',78,'vh',58,NULL,NULL,58,55,1);
...
INSERT INTO `reviews` VALUES (3,3,6,4,'very good',6),(4,4,6,2,'good',4),(5,5,6,2,'good',4),(6,6,6,2,'good',4),(8,8,6,2,'good',4),(9,9,6,1,'very good',5);
...
INSERT INTO `users` VALUES (1,'Sissy','Themeli','sissythem','sissythem','sissy@email.com','55555525','Greece','Athens',NULL,'2017-08-16 19:49:20','about','5-8-1990',NULL),(2,'Nikiforos','Pittaras','nikpit','nikpit','nik@email.com','1254883587','France','Paris','photooos','2017-07-12 13:30:16','this is demo',NULL,'1'),(3,'Eva','Themeli','evathem','evathem','eva@email.com','1258893345','Germany','Berlin',NULL,'2017-07-12 13:30:16',NULL,NULL,'0'),(4,'Minos','Themelis','minosthem','minosthem','minos@email.com','1234559668','Netherlands','Amsterdam',NULL,'2017-07-12 13:30:16',NULL,NULL,'0'),(6,'Anna','Karavokiri','annakara','annakara','anna@email.com','4552587563','Greece','Athens',NULL,'2017-07-12 13:30:16',NULL,NULL,'1'),(103,'anatoli','rontogianni','anatoli','anatoli','anatoli@email.com','6945784216','','',NULL,'2017-07-12 13:30:16','','16-8-2017',NULL),(107,'vasso','moschou','vasso','vasso','vvv@nail.com','45698888','','',NULL,'2017-08-16 19:38:45','','16-8-1975',NULL);
...
-- Dump completed on 2017-08-16 22:58:51
