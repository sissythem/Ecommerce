...
//        });
        ...
        etType.setText(selectedResidence.getType());
        ...
        bcontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    boolean success = PutResult(host, type, about, address, city, country, amenities, floor, rooms, baths, view, spaceArea, guests, minPrice, additionalCostPerPerson,
    ...
    public boolean PutResult(Users host, String type, String about, String address, String city, String country, String amenities, String floor, String rooms, String baths, String view,
                              ...
                              String kitchen, String livingRoom, String startDate, String endDate, String photo)
    {
        ...
        RestCallParameters residencePostParameters = new RestCallParameters(residencePostURL, "PUT", "", ResidenceParameters.getAddResidenceParameters());
