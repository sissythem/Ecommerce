...
public class AddResidenceParameters {
    ...
    public AddResidenceParameters (Users host, String title, String type, String about, String address, String city, String country, String amenities, String floor, String rooms, String baths,
        ...
        AddResidenceParams.put("title", title);
